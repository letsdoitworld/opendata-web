            ...
            <div className={this.props.aboutClassName}>
                <main className="main-content about-page">
                    ...
                    <section className="section">
                        ...
                        <p>
                            Let’s Do It! World is a civic-led mass movement that began
                            in Estonia in 2008 when 50,000 people united together to clean up
                            the entire country in just five hours. Since then, Let’s Do It! has
                            spread this model—one country in one day—around the world. To date,
                            nearly 120 countries and 20 million people have joined us to clean
                            up illegal waste.
                        </p>

                        <h3 className="intro">Be aware of the whole world</h3>
                        <p>
                            Let’s Do It! World is a civic-led mass movement that began in Estonia
                             in 2008 when 50,000 people united together to clean up the entire
                              country in just five hours. Since then, Let’s Do It! has spread
                               this model—one country in one day—around the world. To date, nearly
                                120 countries and 20 million people have joined us to clean up
                                 illegal waste.
                        </p>
                    </section>
