...
export default class About extends Component {
    ...
    render() {
        return (
            <div role="none" className="modal" style={{display: this.props.visible ? 'block' : 'none'}} onClick={this.props.onClose}>
                <div role="none" className="modal-content" onClick={e => e.stopPropagation()}>
                    <a role="button" tabIndex={0} className="close" onClick={this.props.onClose}>&times;</a>
                    <div className="info">
